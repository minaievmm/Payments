package ua.nure.minaev.SummaryTask4.web;
...
import ua.nure.minaev.SummaryTask4.web.command.Command;
import ua.nure.minaev.SummaryTask4.web.command.CommandContainer;
...
public class Controller extends HttpServlet {
	...
	private void process(HttpServletRequest request,
		...
		if (request.getMethod().equals("post")) {
			...
			LOG.debug("Controller finished, now redirect to address —> "
					+ forward);
